...
class BaseAgent:
    ...
    def __init__(self, agent_id: str, communicator: UnifiedCommunicationManager, coordinator=None):
        ...
        Args:
            ...
            coordinator: Optional coordinator for legacy support
        """
        ...
        # Legacy support for coordinator pattern
    ...
    def react_to_update(self):
        """
        Legacy method for coordinator pattern.
        Override this in derived classes that use the coordinator pattern.
        """
        pass
