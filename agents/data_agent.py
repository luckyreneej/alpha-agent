...
class DataAgent(BaseAgent):
    ...
    def _process_messages(self):
        ...
        for message in messages:
            try:
                ...
                if message.message_type == utils.communication.message.MessageType.REQUEST:
                    self._handle_request(message)

            except Exception as e:
                logger.error(f"Error processing message: {e}")

    def _handle_request(self, message: utils.communication.message.Message):
        """
    ...
    def _handle_stock_data_request(self, message: utils.communication.message.Message):
        """
    ...
    def _handle_options_data_request(self, message: utils.communication.message.Message):
        """
    ...
    def _handle_news_request(self, message: utils.communication.message.Message):
        """
    ...
    def _notify_data_update(self, update_type: str):
        ...
        broadcast_msg = utils.communication.message.create_broadcast_message(
